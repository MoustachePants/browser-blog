...
//
//   // Helper function to create a node for a style rule
...
//   };
//
//   // Create a map to store nodes by selector
//   const nodeMap: { [selector: string]: CSSOMNode } = {};
//
//   Array.from(stylesheet.cssRules).forEach((rule) => {
//     if (rule.type === CSSRule.STYLE_RULE) {
//       const styleRule = rule as CSSStyleRule;
//       const node = processRule(styleRule);
//       nodeMap[styleRule.selectorText] = node;
//     }
//   });
//
...
//   }
//
//   // Process rules and merge inherited styles
//   Array.from(stylesheet.cssRules).forEach((rule) => {
//     if (rule.type === CSSRule.STYLE_RULE) {
//       const styleRule = rule as CSSStyleRule;
//       const node = nodeMap[styleRule.selectorText];
//
//       // Only update 'html' and 'body' nodes, others are children of 'body'
...
//       } else {
//         // Ensure the node is added as a child of 'body'
//         if (
...
//         <div className="node-container">{node.selectorText}</div>
...
//   };
//
//   console.log(cssomTree);
//   return <>{renderTree(cssomTree)}</>;
// };
//
